...
const CLUES = {
  ring:   { name:"消失的婚戒",
            popup:"死者的婚戒不见了，左手无名指上还留着一圈浅色的压痕，看起来才刚摘下不久。",
...
const script = [
  ...
  { type:"line", bg:"case-photo", speaker:N, text:"来人是洛杉矶警局的林警探。他进门后没有脱下大衣，只把手机放到桌上。照片里是一面斑驳的白墙，墙上留着一个暗红色的符号——一个写得极其潦草的字：「厌」" },
  ...
  { type:"line", speaker:"李智颖", text:"「严守诚平常使用什么文字？」" },
  { type:"line", speaker:N, text:"林警探怔了一下。" },
  { type:"line", speaker:"林警探", text:"「我不知道。」" },
  { type:"line", speaker:"李智颖", text:"「那就是第一件应该知道的事。」" },
  { type:"line", bg:"rain-house", speaker:N, text:"十五分钟后，我和李智颖坐上警车，前往命案现场。雨水敲击车窗，街边的圣诞灯在玻璃上拖成一道道模糊的金线。当我们抵达时，老宅外已经停着三辆警车。" },
  { type:"line", bg:"scene", speaker:N, text:"死者倒在二楼书房中央。他的外套扣得整整齐齐，皮鞋干净得近乎异常。手机、钱包和名表都没有遗失，只有原本戴在左手上的婚戒不见了。房间里有两只酒杯、一瓶开过的红酒，以及一封被撕碎的情书。" },
  { type:"line", speaker:"赵警官", text:"「婚戒、情书，再加上墙上的『厌』。我认为是感情纠纷。死者临终前想写的可能是『厌恶』，或者某个读音接近 Yan 的名字。」" },

  { type:"investigate" },

  { type:"line", bg:"investigation", speaker:N, text:"李智颖没有回答。她先检查死者的鞋底，接着观察门框、地毯和窗台，最后停在血字前。" },
  ...
  { type:"line", bg:"scene", speaker:N, text:"当晚曾有三个人来过老宅。" },
  ...
  { type:"line", speaker:N, text:"李智颖指着「ㄤ」与内部笔画相接之处。" },
  ...
  { type:"line", bg:"car", speaker:N, text:"李智颖看向窗外。一辆黑色轿车停在警戒线外，引擎仍然运转。" },
  { type:"line", speaker:"李智颖", text:"「他一直没有离开。」" },

  { type:"chapter", subtitle:"五、一句不该知道的话" },

  { type:"line", bg:"confrontation", speaker:N, text:"黃致瑋被带进书房时，神情比我预料中更加平静。" },
  ...
  { type:"line", bg:"flashback", speaker:N, text:"三年前，严守诚的公司替医疗机构开发一套紧急语音辨识系统。病患只要说出特定求救词，系统便会自动通知护理人员。然而正式测试前，工程团队发现系统对某些口音的辨识率远低于公司公布的数字。" },
  ...
  { type:"line", speaker:N, text:"没想到严守诚在书房里短暂恢复意识。他咬破嘴唇，用手指沾血，在墙上写下：「ㄏ　ㄨ　ㄤ」" },
  ...
  { type:"line", bg:"confrontation", speaker:"黃致瑋", text:"「他害死了一个人，却还能像什么都没发生一样活着。」" },
  ...
  { type:"line", bg:"ending", speaker:N, text:"案件结束时，已经是圣诞节下午。我和李智颖回到公寓。门口放着一只深红色信封，上面没有邮票，也没有寄件地址。" },
...
"我們運動那天聊到柯南，我記得你喜歡看小說，所以想說送你一個屬於你的偵探故事，我在三個月前就開始做這個聖誕禮物。\n\n"+
"讓你看看月天蠍還是有儀式感的!!\n\n"+
"雖然程式的部分是AI弄得，但劇情的發想以及這封信都是我親自編排的。\n\n"+
"在故事裡，所有人看見的都是一個「厌」字。只有你願意停下來，不被它表面的意思帶走，而是重新觀察每一筆真正的來歷。\n\n"+
"或許這就是我心中的你。\n\n"+
...
const BG_CLASS = {
  room:          "scene-bg-room",
  "case-photo":  "scene-bg-case-photo",
  "rain-house":  "scene-bg-rain-house",
  scene:         "scene-bg-scene",
  investigation: "scene-bg-investigation",
  car:           "scene-bg-car",
  confrontation: "scene-bg-confrontation",
  flashback:     "scene-bg-flashback",
  ending:        "scene-bg-ending"
};
...
function renderLine(step){
  ...
  $("vn-bg").className = "scene-bg " + (BG_CLASS[currentBg] || "scene-bg-room");
